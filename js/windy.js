...
var Windy = function( params ){
    ...
    var animate = function(bounds, field) {
        ...
        function windIntensityColorScale(step, maxWind) {
            //result = ["#d73027","#f46d43","#fdae61","#fee090","#ffffbf","#e0f3f8","#abd9e9","#74add1","#4575b4"]; //red orange color pallette
            //result = ["#f7fbff","#deebf7","#c6dbef","#9ecae1","#6baed6","#4292c6","#2171b5","#08519c","#08306b"]; //white-blue color pallette
            result = ["#f7f4f9","#e7e1ef","#d4b9da","#c994c7","#df65b0","#e7298a","#ce1256","#980043","#67001f"]; //white-pink
            //result = ["#00441b","#006d2c","#238b45","#41ab5d","#74c476","#a1d99b","#c7e9c0","#e5f5e0","#f7fcf5"].reverse(); //white to green (green to white looked strange)
